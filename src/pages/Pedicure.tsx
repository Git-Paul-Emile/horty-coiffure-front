...
const Pedicure = () => {
  ...
  // Get subcategories for pedicure-manucure
  const pedicureSubcategories = categories.filter(cat => cat.parentId === 'pedicure-manucure');

  // Filter services for pedicure-manucure and apply filters
  const filteredServices = useMemo(() => {
    let filtered = services.filter(service =>
      pedicureSubcategories.some(sub => sub.id === service.category)
    );
    ...
    return filtered;
  }, [services, pedicureSubcategories, selectedCategory, searchTerm]);
                ...
                {categoryServices.map((service, index) => (
                  ...
                  >
                    ...
                    <div className="relative h-64 overflow-hidden">
                      <img
                        src={service.image || '/pedicure.jpg'}
                        alt={service.name}
